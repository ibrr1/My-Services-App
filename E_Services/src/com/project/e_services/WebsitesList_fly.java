...
public class WebsitesList_fly extends Activity {
	// Declare Variables
	ListView listview;
	List<ParseObject> ob;
	ProgressDialog mProgressDialog;
	WebsitesListViewAdapter_fly adapter;
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(WebsitesList_fly.this);
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("Fly_Websites");
				// by ascending
		...
		protected void onPostExecute(Void result) {
			...
			adapter = new WebsitesListViewAdapter_fly(WebsitesList_fly.this,websiteslist);
