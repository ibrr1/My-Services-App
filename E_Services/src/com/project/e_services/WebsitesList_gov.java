...
public class WebsitesList_gov extends Activity {
	// Declare Variables
	ListView listview;
	List<ParseObject> ob;
	ProgressDialog mProgressDialog;
	WebsitesListViewAdapter_gov adapter;
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(WebsitesList_gov.this);
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("Gov_Websites");
				// by ascending
		...
		protected void onPostExecute(Void result) {
			...
			adapter = new WebsitesListViewAdapter_gov(WebsitesList_gov.this,websiteslist);
