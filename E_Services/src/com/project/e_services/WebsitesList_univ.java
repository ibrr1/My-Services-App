...
public class WebsitesList_univ extends Activity {
	// Declare Variables
	ListView listview;
	List<ParseObject> ob;
	ProgressDialog mProgressDialog;
	WebsitesListViewAdapter_univ adapter;
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(WebsitesList_univ.this);
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("Univ_Websites");
				// by ascending
		...
		protected void onPostExecute(Void result) {
			...
			adapter = new WebsitesListViewAdapter_univ(WebsitesList_univ.this,websiteslist);
