...
public class WebsitesList_banks extends Activity {
	// Declare Variables
	ListView listview;
	List<ParseObject> ob;
	ProgressDialog mProgressDialog;
	WebsitesListViewAdapter_banks adapter;
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(WebsitesList_banks.this);
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("Bank_Websites");
				// by ascending
		...
		protected void onPostExecute(Void result) {
			...
			adapter = new WebsitesListViewAdapter_banks(WebsitesList_banks.this,websiteslist);
