...
public class WebsitesList_news extends Activity {
	// Declare Variables
	ListView listview;
	List<ParseObject> ob;
	ProgressDialog mProgressDialog;
	WebsitesListViewAdapter_news adapter;
	...
	private class RemoteDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPreExecute() {
			...
			mProgressDialog = new ProgressDialog(WebsitesList_news.this);
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("News_Websites");
				// by ascending
		...
		protected void onPostExecute(Void result) {
			...
			adapter = new WebsitesListViewAdapter_news(WebsitesList_news.this,websiteslist);
